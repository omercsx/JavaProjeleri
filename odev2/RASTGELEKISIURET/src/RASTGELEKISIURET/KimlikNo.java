...
public class KimlikNo {
    ...
    public static ArrayList<Boolean> control(ArrayList<String> TC){
        ArrayList<Boolean> TcDurumu = new ArrayList<Boolean>();
        boolean isTrue = false;
        for(int i =0;i<TC.size();i++){
            TcDurumu.add(isTCKN(TC.get(i)));    
        }
        return TcDurumu;
    } 
    
    public static boolean isTCKN(String tckn) {
